...
if(BUILD_SHARED_LIBS)
    list(APPEND exportTargets libprotoc)
    add_library(libprotoc SHARED ${libprotoc_files})
...
list(APPEND exportTargets libprotoc_static)
add_library(libprotoc_static STATIC ${libprotoc_files})
target_link_libraries(libprotoc_static libprotobuf_static)
set_target_properties(libprotoc_static PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES "$<BUILD_INTERFACE:${protobuf_source_dir}/src>;$<INSTALL_INTERFACE:include>"
    INCLUDE_DIRECTORIES "${protobuf_source_dir}/src"
    PREFIX "")
